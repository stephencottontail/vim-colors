...
" Changelog: 2021-06-27 Started UI
...
" - Editor settings -
" -------------------
exe "hi! Normal"          "guifg=".s:polar0 "guibg=".s:snow2  "gui=".s:none
exe "hi! Cursor"          "guifg=".s:polar0 "guibg=".s:polar0 "gui=".s:none
...
" -------------------------
exe "hi! VertSplit"   "guifg=".s:none "guibg=".s:snow1 "gui=".s:none
exe "hi! TabLine"     "guifg=".s:none "guibg=".s:snow1 "gui=".s:none
exe "hi! TabLineFill" "guifg=".s:none "guibg=".s:snow1 "gui=".s:none
exe "hi! TabLineSel"  "guifg=".s:none "guibg=".s:snow0 "gui=".s:none
exe "hi! Title"       "guifg=".s:none "guibg=".s:snow1 "gui=".s:none
...
" - Prompt/Status -
" -----------------
exe "hi! StatusLine"   "guifg=".s:none "guibg=".s:snow0 "gui=".s:none
exe "hi! StatusLineNC" "guifg=".s:none "guibg=".s:snow1 "gui=".s:none
...
exe "hi! Visual"      "guifg=".s:none  "guibg=".s:aurora2 "gui=".s:none
...
exe "hi! CtrlPMatch"     "guifg=".s:none  "guibg=".s:frost0     
exe "hi! CtrlPMode1"     "guifg=".s:none  "guibg=".s:snow0
exe "hi! CtrlPMode2"     "guifg=".s:none  "guibg=".s:snow0
exe "hi! CtrlPNoEntries" "guifg=".s:snow2 "guibg=".s:aurora0
